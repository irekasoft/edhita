...
- (void)addItemDidTap:(id)sender {
  UIAlertController *alertController = [UIAlertController alertControllerWithTitle:[EDHUtility localizedString:@"Create New Item" withScope:EDHFinderPodName] message:nil preferredStyle:UIAlertControllerStyleActionSheet];
