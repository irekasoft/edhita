...
- (NSMutableArray *)children {
  ...
  // modificationDate
  NSSortDescriptor *isDirectorySorting = [[NSSortDescriptor alloc] initWithKey:@"isDirectory" ascending:false];
  NSSortDescriptor *nameSorting = [[NSSortDescriptor alloc] initWithKey:@"name" ascending:true];
  [items sortUsingDescriptors:@[isDirectorySorting,nameSorting]];
